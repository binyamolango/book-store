...
**[Book-Store]** is a web app for all lovers of books that add, delete and store books. Built with React.
...
Clone this repository to your desired folder: `https://github.com/binyamolango/book-store.git`
